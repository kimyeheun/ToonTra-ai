...
from ocr_service.pororo.tasks.utils.base import PororoFactoryBase, PororoSimpleBase
...
class PororoOcrFactory(PororoFactoryBase):
    ...
    def load(self, device: str):
        """
        Load user-selected tasks-specific model

        Args:
            device (str): device information

        Returns:
            object: User-selected tasks-specific model

        """
        if self.config.n_model == "brainocr":
            from ocr_service.pororo import brainocr
