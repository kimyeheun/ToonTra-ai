...
class PororoFactoryBase(object):
    r"""This is a factory base class that construct tasks-specific module"""
    ...
    def __init__(
        ...
        ), f"Following langs are supported for this tasks: {self._available_langs}"
...
class PororoSimpleBase(PororoTaskBase):
    r"""Simple tasks base wrapper class"""
...
class PororoBiencoderBase(PororoTaskBase):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # For "Find Similar Sentence" tasks
...
class PororoGenerationBase(PororoTaskBase):
    r"""Generation tasks wrapper class using various generation tricks"""
...
class PororoTaskGenerationBase(PororoTaskBase):
    r"""Generation tasks wrapper class using only beam search"""
